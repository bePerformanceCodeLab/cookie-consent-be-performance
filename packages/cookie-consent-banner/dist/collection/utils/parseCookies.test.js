...
const mockDocumentCookie = (cookieString) => Object.defineProperty(window.document, "cookie", {
    writable: true,
    value: cookieString,
});
describe("parseCookies", () => {
    ...
    it("should trim leading and trailing spaces", () => {
        const cookieStringLeadingAndTrailingSpaces = " first=someValue ;second=someValue";
        const expectedParsed = {
            first: "someValue",
            second: "someValue",
        };
...
//# sourceMappingURL=parseCookies.test.js.map
